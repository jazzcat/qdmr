...
static Radio::Features _d578uv2_features =
{
  // show beta-warning
  .betaWarning = true,
...
D578UV2::D578UV2(AnytoneInterface *device, QObject *parent)
  : AnytoneRadio("Anytone AT-D578UV III", device, parent), _features(_d578uv2_features)
{
...
D578UV2::defaultRadioInfo() {
  return RadioInfo(
        RadioInfo::D578UV, "d578uv3", "AT-D578UV III", "AnyTone", AnytoneInterface::interfaceInfo());
}
