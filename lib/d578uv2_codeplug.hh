#ifndef D578UV2_CODEPLUG_HH
#define D578UV2_CODEPLUG_HH
...
/** Represents the device specific binary codeplug for Anytone AT-D578UV III radios.
 *
 * @section d578uv2cpl Codeplug structure within radio
 * <table>
 ...
 *
 * @ingroup d578uv2 */
class D578UV2Codeplug : public D578UVCodeplug
{
  Q_OBJECT

public:
  /** Empty constructor. */
  explicit D578UV2Codeplug(QObject *parent = nullptr);
};
